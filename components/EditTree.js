...
const EditTree = ({ name, image, visible, onDismiss, title, treeId, onLoading, isLoading }) => {
            ...
            fetch(apiUrl, {
                ...
                if (data.secure_url != null) {
                    ...
                    let rs = await axios.put(`${REACT_APP_BASE_URL}/plant/update`, {
                        name: text,
                        plantId: treeId,
                        image: data.secure_url != null ? data.secure_url : image
                    }, {
            ...
            <Portal>
                <Dialog visible={visible} onDismiss={onDismiss}>
                    ...
                    <Dialog.Actions>
                        ...
                        <Button onPress={() => { editTree() }}>Edit</Button>
                    </Dialog.Actions>
                </Dialog>
            </Portal>
        </View>
